...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  config.vm.define "k8s-node1" do |subconfig|
    ...
    subconfig.vm.network :private_network, ip: "10.0.10.10"
  ...
  config.vm.define "k8s-node2" do |subconfig|
    ...
    subconfig.vm.network :private_network, ip: "10.0.10.11"
    subconfig.vm.provider :virtualbox do |vb|
      vb.customize [
        'modifyvm', :id,
        '--natdnshostresolver1', 'on',
  ...
  config.vm.define "k8s-node3" do |subconfig|
    ...
    subconfig.vm.network :private_network, ip: "10.0.10.12"
    subconfig.vm.provider :virtualbox do |vb|
      vb.customize [
        'modifyvm', :id,
        '--natdnshostresolver1', 'on',
